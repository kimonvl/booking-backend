...
public interface PartnerPropertyService {
    void createProperty(CreatePropertyRequest request, List<MultipartFile> photos, Integer mainIndex, User user) throws FileUploadException, EntityInvalidArgumentException, InternalErrorException;
}
